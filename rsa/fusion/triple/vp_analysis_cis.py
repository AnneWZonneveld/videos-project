...
results = calc_common_cis_mp(eeg_rdms=eeg_rdms, roi_rdm=roi_rdm, model_rdms=model_rdms, feature_oi=args.feature_oi, jobarr_id=args.jobarr_id, its=10000, n_cpus=args.n_cpus, shm_name=shm_name, method=args.eval_method)
...
file_path = res_folder + f'vp_results_cis_{args.eval_method}.pkl'
