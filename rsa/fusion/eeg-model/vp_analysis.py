"""
Performs main variance partitioning on subject level.
...
results = calc_rsquared_rw2_mp(eeg_rdms=eeg_rdms, design_matrices=design_matrices, jobarr_id=args.jobarr_id, n_cpus=n_cpus, shm_name=f'vp_{args.sub}', its=10000)
...
res_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/{args.data_split}/vp-results/z_{args.zscore}/sfreq-{sfreq_format}/sub-{sub_format}/'
