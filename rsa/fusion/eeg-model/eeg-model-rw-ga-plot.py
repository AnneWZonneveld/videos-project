...
sub_format = 'GA'
if args.bin_width == 0:
    bin_width_format = 0.0

sub_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/reweighted/z_{args.zscore}/bin_{bin_width_format}/slide_{args.slide}/{sub_format}/' 
res_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/reweighted/z_{args.zscore}/bin_{bin_width_format}/slide_{args.slide}/plots/'
