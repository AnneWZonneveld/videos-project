...
sub_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/{args.data_split}/standard/z_{args.zscore}/sub-{sub_format}/model_{args.model_metric}/{args.distance_type}/sfreq_{sfreq_format}/{args.eval_method}/' 
res_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/{args.data_split}/standard/plots/z_{args.zscore}/sub-{sub_format}/model_{args.model_metric}/{args.distance_type}/sfreq_{sfreq_format}/{args.eval_method}/'
...
for feature in features:
    ...
    # ps[feature] = fdrcorrection(ps[feature], alpha=0.05)[1]
...
ax.set_title(f'EEG-model correlation sub {sub_format}')
...
img_path = res_folder + f'cor_{args.distance_type}_{sfreq_format}.png'
