...
results = calc_rsquared_mp(eeg_rdms=eeg_rdms, feature_rdm=feature_rdm, jobarr_id=args.jobarr_id, its=10000, n_cpus=n_cpus, shm_name=shm_name)
...
res_folder = f'/scratch/azonneveld/rsa/fusion/eeg-model/standard/z_{args.zscore}/sub-{sub_format}/{args.distance_type}/bin_{args.bin_width}/slide_{args.slide}/' 
