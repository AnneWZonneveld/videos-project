"""
Calculating 95% confidence interval for variance partioning between model RDMs and fMRI RDM. 
Group level. 
...
results = calc_cis_rw_mp(rois=rois, fmri_data=fmri_rdms, design_matrices=design_matrices, n_cpus=args.n_cpus, its=10000)
