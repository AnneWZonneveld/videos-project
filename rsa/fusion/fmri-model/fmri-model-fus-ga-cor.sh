...
python fmri-model-fus-ga-cor.py  --data_split $data_split --feature $feature --distance_type $distance_type --eval_method $eval_method --rois $rois --n_cpus ${SLURM_CPUS_PER_TASK}