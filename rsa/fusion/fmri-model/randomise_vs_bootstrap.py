"""
Calculating similarity between specified model RDM and fMRI RDM on subject level.
Group level.
Based on bootstrapped significance method.
...
results = calc_cor_ga_mp(rois=rois, fmri_data=fmri_rdms, feature_rdm=model_rdm, its=10000, n_cpus=args.n_cpus, eval_method=args.eval_method, booted=True, noise_ceilings=noise_ceilings)
